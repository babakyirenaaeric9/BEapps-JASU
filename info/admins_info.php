...
<head>
    ...
    <title>Details Of Administrators</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div></div>
            ...
            <div class="abt_us">
                <center>
                    <h2>Details Of Administrators</h2>
                </center>
                ...
                <table border="black">
                    ...
                    <?php
                      ...
                      $sql = "SELECT * FROM signup WHERE usertype = 'Admin'";
                      $result = mysqli_query($conn, $sql); // Fixed function name
                    ...
                    ?>
                        <td><a href="../info/admin_info_detail.php"><button>See More</button></a></td>
