...
<body>
    ...
    <div class="container">
        <div class="wrapper">
            ...
            <hr>
            <div class="abt_us">
                <center><h1>JASU Members And Scholarship Applicants</h1></center>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="../authenticate/signup_me.php">Add A Member</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Number Of DB Admins</td>
                            <?php

                                        


                            $sql = "SELECT COUNT(*) AS count FROM signup where usertype = 'Database Admin'";
                            $result = mysqli_query($conn, $sql);
                            $row = mysqli_fetch_assoc($result);
                            $countdbadmin = $row['count'];

                            ?>

                            <td><?php echo $countdbadmin ?></td>
                            
                            <td><a href="../me/database_admin_info/database_admin_info.php"><button>See More</button></a></td>
                            <td><a href="../authenticate/signup_me.php">Add A Member</a></td>
                        </tr>
