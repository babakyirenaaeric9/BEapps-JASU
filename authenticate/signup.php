...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($password === $confirm_password) {
        ...
        if ($check->num_rows > 0) {
            ...
            $sql = "INSERT INTO signup(student_id, surname, middlename, lastname, gender, dob, phone, email, region, municipal, hometown, password, passport) 
                    VALUES ('$student_id', '$surname', '$middlename', '$lastname', '$gender', '$dob', '$phone', '$email', '$region', '$municipal', '$hometown', '$password', '$passport')";
...
<body>
    ...
    <img src="../images/stu_jasu.png" alt="LOGO" style="width: 150px;">
        ...
        <h2>JIRAPA AREA STUDENT UNION (JASU)</h2>
    </header>
